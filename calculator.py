...
btn_mul = tk.Button(root, text='*', command=lambda: add_to_calculation("*"), width=5, font=("Helvetica",14))
btn_mul.grid(row=4, column=4)

btn_div = tk.Button(root, text='/', command=lambda: add_to_calculation("/"), width=5, font=("Helvetica",14))
btn_div.grid(row=5, column=4)

btn_open = tk.Button(root, text='(', command=lambda: add_to_calculation("("), width=5, font=("Helvetica",14))
btn_open.grid(row=5, column=1)

btn_close = tk.Button(root, text=')', command=lambda: add_to_calculation(")"), width=5, font=("Helvetica",14))
btn_close.grid(row=5, column=3)

btn_equal = tk.Button(root, text='=', command= evaluate_calculation, width=11, font=("Helvetica",14))
btn_equal.grid(row=6, column=3, columnspan = 2)

btn_clear = tk.Button(root, text='AC', command= clear_field, width=11, font=("Helvetica",14))
